...
public class AddDriver extends JFrame implements ActionListener {
     ...
     AddDriver()
     {
    	...
    	heading.setFont(new Font ("Tohome",Font.BOLD,18));
    	heading.setBounds(150,10 ,200 ,20 );
    	add(heading);
    	
    	JLabel lblroomno = new JLabel("Name");
    	lblroomno.setFont(new Font ("Tohome",Font.BOLD,16));
    	...
    	lblage.setFont(new Font ("Tohome",Font.BOLD,16));
    	...
    	JLabel lblcleas = new JLabel("Gender");
    	lblcleas.setFont(new Font ("Tohome",Font.BOLD,16));
    	lblcleas.setBounds(60,150,120,30);
    	add(lblcleas);
    	...
    	lblprice.setFont(new Font ("Tohome",Font.BOLD,16));
    	...
    	lbltype.setFont(new Font ("Tohome",Font.BOLD,16));
    	...
    	lblavailable.setFont(new Font ("Tohome",Font.BOLD,16));
    	...
    	lbllocation.setFont(new Font ("Tohome",Font.BOLD,16));
